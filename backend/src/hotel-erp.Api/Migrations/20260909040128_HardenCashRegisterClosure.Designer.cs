...
namespace hotel_erp.Api.Migrations
{
    ...
    [Migration("20260909040128_HardenCashRegisterClosure")]
    partial class HardenCashRegisterClosure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hotel_erp.Api.Database.Entities.CashMovement", b =>
                {
                    ...
                    b.HasIndex("CashRegisterId", "MovementDate", "CreatedAt");
            ...
            modelBuilder.Entity("hotel_erp.Api.Database.Entities.CorrelativeLock", b =>
                {
            ...
            modelBuilder.Entity("hotel_erp.Api.Database.Entities.Invoice", b =>
                {
                    ...
                    b.HasIndex("CAIId", "CorrelativeNumber")
                        .IsUnique();

                    b.HasIndex("DocumentAuthorizationId", "CorrelativeNumber")
                        .IsUnique();
