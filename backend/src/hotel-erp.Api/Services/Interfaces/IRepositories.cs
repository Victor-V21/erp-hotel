...
namespace hotel_erp.Api.Services.Interfaces
{
    ...
    public interface ISupplierRepository
    {
        ...
        Task<Supplier?> GetByRTNAsync(string rtn);
        Task<IEnumerable<Supplier>> GetAllAsync();
        Task<IEnumerable<Supplier>> SearchAsync(string term);
    ...
    public interface IPurchaseInvoiceRepository
    {
        ...
        Task<IEnumerable<PurchaseInvoice>> GetByDateRangeAsync(DateTime start, DateTime end);
        Task<IEnumerable<PurchaseInvoice>> GetBySupplierAsync(Guid supplierId);
        Task AddAsync(PurchaseInvoice purchaseInvoice);
        Task UpdateAsync(PurchaseInvoice purchaseInvoice);
        Task DeleteAsync(Guid id);
    }
